...
O primeiro pensamento que vem à tona é a semelhança do enunciado com o Problema da Partição\footnote{\url{https://en.wikipedia.org/wiki/Partition_problem}}. Na verdade, o problema enunciado pode ser encarado como uma instância particular deste problema clássico.
...
Para encontrar a partição basta iterar em todos os elementos de maneira reversa, mantendo um contador representando a \quotes{folga} de um dos conjuntos, do mesmo jeito que foi feito na demonstração. Pode ser implementado em tempo linear utilizando memória constante.